...
${amount} para ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        automateApprovalsWithAgentsTitle: 'Automatiza aprobaciones con agentes',
        automateApprovalsWithAgentsSubtitle: 'Agrega un agente al flujo de trabajo para automatizar las aprobaciones.',
